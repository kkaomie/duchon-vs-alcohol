function initGame(level) {
        ...
        function startGame() {
            ...
            class Plant {
                constructor(type, gridX, gridY) {
                    ...
                    this.plantedTime = Date.now(); // Track when plant was placed
                }
                ...
                attack(enemies) {
                    if (this.isOnCooldown()) return; // Don't attack if on cooldown
            ...
            function gameLoop() {
                ...
                if (gameOver) {
                    ...
                    ctx.textAlign = 'center';
                    ctx.textBaseline = 'middle';
                    ctx.fillText('zachránil si Veľkého Duchoňa (aspoň pred alkoholom)', canvas.width / 2, canvas.height / 2 - 60);
    ...
    function playLevel2() {
        ...
        function startGame() {
            ...
            let GRID_COLS = 10;
            let GRID_ROWS = 6;
            let UNLOCKED_ROWS = 4; // 4 rows for Level 2
            let GRID_CELL_WIDTH = 60;
            let GRID_CELL_HEIGHT = 60;
            let SIDE_PADDING = 200; // Moved arena to the right
            let TOP_PADDING = 100;
            ...
            class Plant {
                constructor(type, gridX, gridY) {
                    ...
                    this.shootStartTime = 0;
                    this.plantedTime = Date.now(); // Track when plant was placed
                    this.lastSunSpawn = 0; // Track when last sun was spawned by this plant
                }
                ...
                spawnSun() {
                    ...
                    if (now - this.lastSunSpawn >= this.type.sunSpawnInterval) {
                        ...
                        sun.sourcePlant = this; // Track which plant produced this sun
            ...
            class Sun {
                constructor(x) {
                    ...
                    this.speed = 1;
                    this.targetY = GRID_START_Y + Math.random() * (GRID_ROWS * GRID_CELL_HEIGHT);
                    this.sourcePlant = null; // Track which plant produced this sun
                }
            ...
            function handleGameInput(e) {
                ...
                suns_on_screen = suns_on_screen.filter(sun => {
                    if (sun.isClicked(mouseX, mouseY)) {
                        suns += sun.value;
                        // Reset timer for the plant that produced this sun
                        if (sun.sourcePlant) {
            ...
            function gameLoop() {
                ...
                // Plants spawn suns if they are sunflowers
                for (let plant of plants) {
                    if (plant.type === PLANT_TYPES.sunflower && !gamePaused) {
                        plant.spawnSun();
                    }
                }
